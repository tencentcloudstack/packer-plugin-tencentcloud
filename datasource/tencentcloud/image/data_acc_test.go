...
//go:embed test-fixtures/image.pkr.hcl
var testImageDatasource string
...
func TestAccImageDatasource(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		...
		Check: func(buildCommand *exec.Cmd, logfile string) error {
			...
			idLog := "null.basic-example: id: img-kvtbik4g"
			nameLog := "null.basic-example: name: image-family-test"
